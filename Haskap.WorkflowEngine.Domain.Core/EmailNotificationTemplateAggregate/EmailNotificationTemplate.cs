...
namespace Haskap.WorkflowEngine.Domain.Core.EmailNotificationTemplateAggregate
{
    public class EmailNotificationTemplate : NotificationTemplate
    {
        ...
        {
            get { return validatedToAddresses.AsReadOnly(); }
            private set { validatedToAddresses = value.ToList(); } 
        }
        public IEnumerable<EmailNotificationAddress> CcAddresses
        {
            get { return validatedCcAddresses.AsReadOnly(); }
            private set { validatedCcAddresses = value.ToList(); }
        }
        public IEnumerable<EmailNotificationAddress> BccAddresses
        {
            get { return validatedBccAddresses.AsReadOnly(); }
            private set { validatedBccAddresses = value.ToList(); }
        }
